...
var tags = ['Good for groups', 'Desserts', 'Appetizers', 'Desserts', 'Appetizers', 'Drinks','Kid friendly'];

let jabber = new Jabber(buzzWords, 2);
...
const createReview = (resId) => {
  ...
  // review.dineDate = faker.date.between('2019-01-01', '2020-01-24');
